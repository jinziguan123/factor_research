...
class AmihudIlliquidityEvo3_20dFiltered(BaseFactor):
    factor_id = 'amihud_illiquidity_neg_evo5'
    display_name = 'Amihud非流动性改进3号（短期反转，滤波）'
    category = 'custom'
    description = '用日内振幅/成交额20日均值衡量价格冲击，取相反数使高流动性股票得分高，因子值越大预期未来5日收益越正；叠加市场状态滤波减少危机期信号。'
    hypothesis = '流动性溢价假设——低流动性股票需更高预期收益补偿，但高频振幅更能捕捉订单流价格冲击。较短窗口（20日）提升换手，取相反数后高流动性得分高正向预测收益。机制：流动性提供者库存风险溢价+日内波动反映信息不对称。市场急跌时流动性枯竭，因子失效，通过市场平均收益滤波抑制信号，规避危机期暴跌风险。在单边牛市或流动性泛滥阶段因子可能弱化。'
